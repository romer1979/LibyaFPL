# -*- coding: utf-8 -*-
"""
Verify Standings Script

This script calculates what GW21 standings SHOULD be and compares them
to what's currently in the database - WITHOUT making any changes.

Run from Render Shell:
    python verify_standings.py
"""
...
def calculate_league_gw21(league_type, league_config, player_info):
    ...
    for gw in range(1, 22):
        ...
        for match in matches:
            ...
            if p1 > p2:
                league_standings[t1] += 3
            elif p2 > p1:
                league_standings[t2] += 3
            else:
                league_standings[t1] += 1
                league_standings[t2] += 1
        
        # Add FPL points
        for team in teams.keys():
            fpl_totals[team] += gw_team_points.get(team, 0)
...
def main():
    ...
    for league_type, result in all_results.items():
