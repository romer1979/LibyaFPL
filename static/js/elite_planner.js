...
async function load(entry='') {
    ...
    try {
        ...
        data=result; plans={my: PlannerRules.create(data.squad,data.settings,data.finances,data.players), opponent: PlannerRules.create(data.opponent_squad,data.opponent_settings,data.opponent_finances,data.players)}; $('published').textContent='GW '+data.published_gameweek;
